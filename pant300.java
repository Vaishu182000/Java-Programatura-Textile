...
public class pant300 extends JFrame{
    ...
    float amount=0;
    pant300(String UserNameLogin){
        value=UserNameLogin;
        value+="\n---------------------------";
        frame=new JFrame("Pant Collection");
        frame.setLayout(null);
        img1=new ImageIcon(getClass().getResource("pant1.jpg"));
        img2=new ImageIcon(getClass().getResource("pant6.jpg"));
        ...
        try{
            ...
            ResultSet rs=stmt.executeQuery("SELECT * FROM Pant3 where Material='"+m1+"'");
            if (rs.next()){
            ...
            rs=stmt.executeQuery("SELECT * FROM Pant3 where Material='"+m2+"'");
            if (rs.next()){
                String a=rs.getString("Amount");
                String s=rs.getString("Size");
                String st=rs.getString("Stocks");
            ...
            public void actionPerformed(ActionEvent e){
               try{
                   ...
                   Class.forName("com.mysql.jdbc.Driver");
                    ...
                    Connection conn=DriverManager.getConnection(connectString,"root","");
                    Statement stmt=conn.createStatement();
                    stmt.execute("UPDATE Pant3 set Stocks=Stocks-1 where Stocks>=0 AND Material='"+l+"'");
                    ResultSet rs=stmt.executeQuery("SELECT * FROM Pant3 where Material='"+l+"'");
                    if(rs.next()){
