...
public class tshirt500 extends JFrame{
    ...
    float amount=0;
    tshirt500(String UserNameLogin){
        value=UserNameLogin;
        value+="\n---------------------------";
        frame=new JFrame("T-Shirts Collection");
        frame.setLayout(null);
        img1=new ImageIcon(getClass().getResource("tshirt3.jpg"));
        img2=new ImageIcon(getClass().getResource("tshirt4.jpg"));
        ...
        try{
            ...
            ResultSet rs=stmt.executeQuery("SELECT * FROM boyscasual1 where Material='"+m1+"'");
            if (rs.next()){
            ...
            rs=stmt.executeQuery("SELECT * FROM boyscasual1 where Material='"+m2+"'");
            if (rs.next()){
                String a=rs.getString("Amount");
                String s=rs.getString("Size");
                String st=rs.getString("Stocks");
            ...
            public void actionPerformed(ActionEvent e){
               try{
                   ...
                   Class.forName("com.mysql.jdbc.Driver");
                    ...
                    Connection conn=DriverManager.getConnection(connectString,"root","");
                    Statement stmt=conn.createStatement();
                    stmt.execute("UPDATE BoysCasual1 set Stocks=Stocks-1 where Stocks>=0 AND Material='"+l+"'");
                    ResultSet rs=stmt.executeQuery("SELECT * FROM boyscasual1 where Material='"+l+"'");
                    if(rs.next()){
